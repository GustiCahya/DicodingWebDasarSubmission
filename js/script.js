...
var typed1 = new Typed('.element1', {
    strings: [
        ...
        '`"klik next"` ^4000',
        'aku suka melihat senyumannya',
        'aku selalu terngiang dengan suaranya',
        'aku ingin tetap bersamanya sampai kapanpun',
        'tetap bersama^1000 selamanya',
        'karena dia sangat berharga bagiku',
        'dia sangat pengertian dan ramah',
        'ia juga mudah memahamiku dan kuharap dia bisa menerima segala kekuranganku',
        'semoga dia tetap baik-baik saja',
        ...
        'I love you ❤️^3000',
        '`"klik next"`^10000',
        'terlalu lebay kan :v btw, mungkin tahun depan saya ndak ngasih hadiah... inget ya mungkin tapi... bisa iya bisa tidak...'
    ],
    typeSpeed: 70
  });